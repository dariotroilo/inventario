...
function guardarCantidad() {
    ...
    document.getElementById("cantidadInput").value = 0F;
...
if (request.getParameter("descri") != null ) {
...
%>       
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <button type="submit" class="btn-cantidad" name="btnGuardarCantidad" onclick="return guardarCantidad()">Guardar</button>
            </td>
        </tr>
        <tr>
            <td>Descripción:</td>
