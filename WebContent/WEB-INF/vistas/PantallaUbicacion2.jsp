							...
							<tbody>
								...
								<tr>
									...
									<td align="center" id="idTd">
										<button type="submit" class="btn-modificar"	name="IdArticuloModificar" value="<%= userubicacion.getId().toString() %>">Modificar</button>
									</td>
								</tr>
								<%
									}
							...
							<div class="col-xs-6 text-right">
								<ul class="pagination">
									<li><a href="#" aria-label="Anterior"> <span
											aria-hidden="true">&laquo;</span> Anterior
									</a></li>
									<li><a href="#">1</a></li>
